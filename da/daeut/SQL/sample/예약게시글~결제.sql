...
VALUES 
    ('ORD001', 1, 'PENDING', 1, 300, 1, '화장실 청소 예약'),
    ('ORD002', 2, 'PAID', 2, 400, 2, '빨래 전문 예약');
...
VALUES 
    ('Card', 'PAID', 'ORD001', '2023-07-05 10:00:00', '인천광역시 남동구'),
    ('Card', 'PAID', 'ORD002', '2023-07-06 15:00:00', '서울특별시 강남구');
