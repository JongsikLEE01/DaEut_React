      ...
      <div className="container">
        ...
        <div className="swiper-container">
          <div className="swiper-wrapper">
            <div className="swiper-slide"><img src={`${process.env.PUBLIC_URL}/img/slide01.png`} alt="" /></div>
            <div className="swiper-slide"><img src={`${process.env.PUBLIC_URL}/img/slide02.png`} alt="" /></div>
            <div className="swiper-slide"><img src={`${process.env.PUBLIC_URL}/img/slide03.png`} alt="" /></div>
          </div>
              ...
              <div className="row gx-5 align-items-center">
                <div className="col-lg-2 order-lg-1">
                  <div className="text-center">
                    <i className="bi bi-building icon-feature text-gradient d-block mb-3 icon"></i>
                ...
                <div className="col-lg-2 order-lg-1">
                  <div className="text-center">
                    <i className="bi bi-calendar-check icon-feature text-gradient d-block mb-3 icon"></i>
                ...
                <div className="col-lg-2 order-lg-1">
                  <div className="text-center">
                    <i className="bi-brush icon-feature text-gradient d-block mb-3 icon"></i>
        ...
        <section className="section01">
          <div className="px-5 ">
            <div className="row gx-5 align-items-center justify-content-center justify-content-lg-between scroll_wrap">
              <div className="col-12 col-lg-5 scroll_wrap scroll_on type_bottom">
                <h2 className="display-4 lh-1 mb-4 h2">Everywhere</h2>
                <p className="lead fw-normal text-muted mb-5 mb-lg-0" >입주 청소, 정기 청소, 화장실 등 어디든, 저희 다이웃은 함께하면 어디든 깨끗해집니다.<br /> 고객님의 편안하고 안정적인 생활과 건강을 위해 최선을 다하겠습니다.<br /> 다이웃과 함께라면 청결한 환경을 유지하는 것이 더욱 간편해집니다.</p>
              </div>
              <div className="col-sm-8 col-md-6 scroll_on type_bottom">
                <div className="px-5 px-sm-0"><img src={`${process.env.PUBLIC_URL}/img/index01.png`} alt="설명이미지" className="img-fluid rounded-circle" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="section02">
          <div className="px-5 ">
            <div className="row gx-5 align-items-center justify-content-center justify-content-lg-between scroll_wrap">
              <div className="col-sm-8 col-md-6 scroll_on type_bottom">
                <div className="px-5 px-sm-0"><img src={`${process.env.PUBLIC_URL}/img/index02.png`} alt="설명이미지" className="img-fluid rounded-circle" />
                </div>
              </div>
              <div className="col-12 col-lg-5 scroll_on type_bottom" >
                <h2 className="display-4 lh-1 mb-4 h2">Eco friendly</h2>
                <p className="lead fw-normal text-muted mb-5 mb-lg-0" >저희 다이웃은 고객님의 건강을 최우선으로 생각하여 오직 친환경약품을 사용합니다.<br /> 이를 통해 환경과 건강에 동시에 이로운 선택을 할 수 있습니다.<br /> 우리의 목표는 고객님의 만족과 건강한 생활 환경을 돕는 것입니다</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="px-5 ">
            <div className="row gx-5 align-items-center justify-content-center justify-content-lg-between scroll_wrap">
              <div className="col-12 col-lg-5 scroll_on type_bottom">
                ...
                <p className="lead fw-normal text-muted mb-5 mb-lg-0">다이웃 파트너는 엄격한 심사 과정을 거쳐 승인된 파트너들만 활동하고 있습니다.<br /> 저희는 개별적으로 모든 파트너를 심사하여 그들의 신뢰성과 서비스 품질을 보장합니다.<br /> 이를 통해 안전하고 믿을 수 있는 서비스를 제공하며, 고객들이 걱정 없이 다이웃 파트너를 이용할 수 있도록 최선을 다하고 있습니다.</p>
              </div>
              <div className="col-sm-8 col-md-6 scroll_on type_bottom">
                <div className="px-5 px-sm-0"><img src={`${process.env.PUBLIC_URL}/img/index03.png`} alt="설명이미지" className="img-fluid rounded-circle" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="cta scroll_wrap">
          <div className="cta-content scroll_on type_bottom">
            <div className="container px-5 scroll_on">
              ...
              <a className="btn btn-outline-light py-3 px-4 w-auto" href="/reservation/reservation">지금 예약하기</a>
            </div>
          </div>
        </section>
      </div>
