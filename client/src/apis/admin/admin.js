...
// 파트너 수정 화면
export const updatePartner = async (userNo) => api.get(`/admin/adminPartnerUpdate/${userNo}`)

// 파트너 수정 처리
export const updatePartnerDetails = async (userNo, partner) => api.put(`/admin/adminPartnerUpdate/${userNo}`, partner)

// 파트너 삭제
export const deletePartner = async (userNo) => api.delete(`/admin/adminPartnerDelete/${userNo}`)
