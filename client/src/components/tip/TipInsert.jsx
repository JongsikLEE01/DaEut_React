  ...
  return (
    <div className="container">
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        <div className="mb-3 d-flex align-items-center rounded px-3 py-2 custom-border">
        ...
        <div className="mb-2 mt-4 d-flex align-items-center">
          ...
          <label htmlFor="thumbnail" className="btn btn-outline-secondary file-upload-button1">첨부하기</label>
        </div>
        ...
        <div className="mb-2 mt-4 d-flex align-items-center">
          ...
          <label htmlFor="file" className="btn btn-outline-secondary file-upload-button1">첨부하기</label>
        </div>
        <div className="form-text mb-3">사진은 최대 20MB 이하의 JPG, PNG, GIF 파일 10장까지 첨부 가능합니다.</div>
