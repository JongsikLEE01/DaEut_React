  ...
  return (
    <div className={styles.container}>
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className="mb-2 mt-4 d-flex align-items-center">
          <label htmlFor="file" className={`form-label me-3 ${styles['label-adjust']}`}>첨부파일</label>
          ...
          <label htmlFor="file" className={`btn btn-outline-secondary ${styles['file-upload-button1']}`}>첨부하기</label>
        </div>
        <div className="form-text mb-3">사진은 최대 20MB 이하의 JPG, PNG, GIF 파일 10장까지 첨부 가능합니다.</div>
        ...
        <div className="d-flex justify-content-end">
          ...
          <a href="/tip/boards" className={`btn btn-outline-secondary ${styles['btn-outline-secondary-custom']}`}>목록</a>
        </div>
      </form>
    </div>
  );
