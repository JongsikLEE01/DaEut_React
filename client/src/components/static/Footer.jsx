...
const Footer = () => {
  return (
    <footer classNameName="footer mt-auto">
        <div className="row">
            <div className="col-md-11 d-flex justify-content-center">
                <ul className="nav">
                    <li className="nav-item">
                        <spa className="nav-link">회사 소개</spa>
                    </li>
                    <li className="nav-item">
                        <div className="nav-link">이용약관 및 규칙</div>
                    </li>
                    <li className="nav-item">
                        <div className="nav-link">개인정보 처리 방침 및 청소년보호정책</div>
                    </li>
                    <li className="nav-item">
                        <div className="nav-link">광고문의</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div className="row mt-3">
            ...
            <div className="col-md-3 company-info text-center text-md-left">
                ...
                <p className="letter-spacing">이메일 문의: daeut@gmail.com</p>
            </div>
